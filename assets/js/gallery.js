...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Gallery page DOM loaded, initializing...');
    ...
    if (sideMenuTogglers.length > 0 && sidemenuWrapper) {
        sideMenuTogglers.forEach(toggler => {
            toggler.addEventListener('click', function (e) {
                e.preventDefault();
                e.stopPropagation();
                console.log('Sidemenu toggler clicked in gallery.js');

                // Make sure sidemenuWrapper is visible before toggling
                sidemenuWrapper.style.visibility = 'visible';
...
function closeSidemenu() {
    console.log('Closing sidemenu from gallery.js');
    const sidemenuWrapper = document.getElementById('sidemenuWrapper');
    if (sidemenuWrapper) {
        // Use a slight delay to allow for animation
        setTimeout(() => {
...
// terms.js - JavaScript functionality for the Terms page
...
function showSideLoginForm() {
    ...
    if (loginFormSide) loginFormSide.style.display = 'block';
    if (signupFormSide) signupFormSide.style.display = 'block';
