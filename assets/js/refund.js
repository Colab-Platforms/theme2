...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Refund page DOM loaded, initializing...');
    ...
    console.log('Refund page initialized successfully');
});
    ...
    if (sideMenuTogglers.length > 0 && sidemenuWrapper) {
        sideMenuTogglers.forEach(toggler => {
            toggler.addEventListener('click', function () {
                console.log('Sidemenu toggler clicked in refund.js');
...
function closeSidemenu() {
    console.log('Closing sidemenu from refund.js');
    const sidemenuWrapper = document.getElementById('sidemenuWrapper');
    if (sidemenuWrapper) {
